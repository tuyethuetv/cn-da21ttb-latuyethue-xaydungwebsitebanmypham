                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-12" style="border: solid grey 1px; padding-top: 10px; padding-bottom: 10px;">
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control" id="thumbnail" name="thumbnail" accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*" onchange="updateThumbnail()">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="category_id" id="category_id" required="true">
                                    ...
                                    foreach ($categoryItems as $item) {
                                        $selected = ($item['id'] == $category_id) ? 'selected' : '';
